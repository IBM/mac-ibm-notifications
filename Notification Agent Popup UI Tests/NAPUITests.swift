...
class NAPUITests: XCTestCase {
    ...
    func testA2Popup() throws {
        let useCase = """
        {"notification":{"topicID":"untracked","mainButton":{"label":"OK","callToActionType":"none","callToActionPayload":""},"hideTitleBarButtons":false,"retainValues":false,"accessoryViews":[],"alwaysOnTop":false,"type":"popup","subtitle":"This is a subtitle","silent":false,"showSuppressionButton":false,"miniaturizable":false,"forceLightMode":false,"notificationID":"untracked","isMovable":true,"disableQuit":false},"settings":{"isVerboseModeEnabled":false,"environment":"prod"}}
        """ // pragma: allowlist-secret
        if let useCaseData = useCase.data(using: .utf8) {
            let app = XCUIApplication()
            app.launchArguments = [useCaseData.base64EncodedString()]
    ...
    func testA3Popup() throws {
        let useCase = """
        {"notification":{"topicID":"untracked","mainButton":{"label":"OK","callToActionType":"none","callToActionPayload":""},"hideTitleBarButtons":false,"retainValues":false,"accessoryViews":[],"alwaysOnTop":false,"type":"popup","title":"This is a title","position":"top_left","subtitle":"This is a subtitle","silent":false,"showSuppressionButton":false,"miniaturizable":false,"forceLightMode":false,"notificationID":"untracked","isMovable":true,"disableQuit":false},"settings":{"isVerboseModeEnabled":false,"environment":"prod"}}
        """ // pragma: allowlist-secret
        if let useCaseData = useCase.data(using: .utf8) {
            let app = XCUIApplication()
            app.launchArguments = [useCaseData.base64EncodedString()]
    ...
    func testA4Popup() throws {
        let useCase = """
        {"notification":{"topicID":"untracked","mainButton":{"label":"OK","callToActionType":"none","callToActionPayload":""},"hideTitleBarButtons":false,"retainValues":false,"accessoryViews":[],"alwaysOnTop":false,"type":"popup","title":"This is a title","subtitle":"This is a subtitle","silent":true,"showSuppressionButton":false,"miniaturizable":false,"forceLightMode":false,"notificationID":"untracked","isMovable":true,"disableQuit":false},"settings":{"isVerboseModeEnabled":false,"environment":"prod"}}
        """ // pragma: allowlist-secret
        if let useCaseData = useCase.data(using: .utf8) {
            let app = XCUIApplication()
            app.launchArguments = [useCaseData.base64EncodedString()]
    ...
    func testA5Popup() throws {
        let useCase = """
        {"notification":{"topicID":"untracked","mainButton":{"label":"Primary","callToActionType":"none","callToActionPayload":""},"secondaryButton":{"label":"Secondary","callToActionType":"none","callToActionPayload":""},"hideTitleBarButtons":false,"retainValues":false,"accessoryViews":[],"alwaysOnTop":false,"type":"popup","title":"This is a title","subtitle":"This is a subtitle","silent":false,"showSuppressionButton":false,"miniaturizable":false,"forceLightMode":false,"notificationID":"untracked","isMovable":true,"disableQuit":false},"settings":{"isVerboseModeEnabled":false,"environment":"prod"}}
        """ // pragma: allowlist-secret
        if let useCaseData = useCase.data(using: .utf8) {
            let app = XCUIApplication()
            app.launchArguments = [useCaseData.base64EncodedString()]
    ...
    func testA7Popup() throws {
        let useCase = """
        {"notification":{"topicID":"untracked","mainButton":{"label":"Primary","callToActionType":"none","callToActionPayload":""},"secondaryButton":{"label":"Secondary","callToActionType":"none","callToActionPayload":""},"hideTitleBarButtons":false,"retainValues":false,"accessoryViews":[],"alwaysOnTop":false,"type":"popup","title":"This is a title","subtitle":"This is a subtitle","silent":false,"showSuppressionButton":false,"miniaturizable":false,"barTitle":"Some","forceLightMode":false,"notificationID":"untracked","isMovable":true,"disableQuit":false},"settings":{"isVerboseModeEnabled":false,"environment":"prod"}}
        """ // pragma: allowlist-secret
        if let useCaseData = useCase.data(using: .utf8) {
            let app = XCUIApplication()
            app.launchArguments = [useCaseData.base64EncodedString()]
    ...
    func testD3Popup() throws {
        let useCase = """
        {"notification":{"topicID":"untracked","mainButton":{"label":"Primary","callToActionType":"none","callToActionPayload":""},"secondaryButton":{"label":"Secondary","callToActionType":"none","callToActionPayload":""},"iconPath":"","hideTitleBarButtons":false,"retainValues":false,"alwaysOnTop":false,"type":"popup","title":"This is a title","subtitle":"This is a subtitle","customWidth":"1000","silent":false,"showSuppressionButton":false,"miniaturizable":false,"barTitle":"Some","forceLightMode":false,"notificationID":"untracked","isMovable":true,"disableQuit":false, "accessoryViews":[{"type":"whitebox","payload":"Some text in the whitebox accessory view Some text in the whitebox accessory view Some text in the whitebox accessory view Some text in the whitebox accessory view Some text in the whitebox accessory view Some text in the whitebox accessory view Some text in the whitebox accessory view Some text in the whitebox accessory view"}]},"settings":{"isVerboseModeEnabled":false,"environment":"prod"}}
        """ // pragma: allowlist-secret
        if let useCaseData = useCase.data(using: .utf8) {
            let app = XCUIApplication()
            app.launchArguments = [useCaseData.base64EncodedString()]
